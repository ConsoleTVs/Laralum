...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <i class="right angle icon divider"></i>
        <div class="active section">{{  trans('laralum.CRUD_edit_title') }}</div>
    </div>
@endsection
@section('title', trans('laralum.CRUD_edit_title'))
@section('icon', "edit")
@section('subtitle', trans('laralum.CRUD_edit_subtitle', ['id' => $row->id, 'table' => $name]))
@section('content')
